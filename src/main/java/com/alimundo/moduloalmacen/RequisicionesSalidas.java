...
import static com.alimundo.moduloalmacen.RequisicionesEntradas.modelorequisicion;
...
public class RequisicionesSalidas extends javax.swing.JDialog{
    ...
    public RequisicionesSalidas() {
        ...
        try{
            ...
            ResultSet rs = null;
            ps = con.EstablecerConexion().prepareStatement("EXEC spu_retornadatosrequisicionsalida");
            rs = ps.executeQuery();
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RequisicionesSalidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
